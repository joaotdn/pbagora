<?php
global $post;
$terms = wp_get_post_terms( $post->ID, 'colunistas' );
$term = $terms[0];
        ...
        <header class="divide-20 column">
            <figure class="small-12 left colunista-info">
                ...
                <div class="small-2 medium-1 left">
                    <a href="<?php echo $archive; ?>" title="<?php echo $term->name; ?>" class="primary d-block">
                        <img src="<?php echo $avatar; ?>" alt="">
                    </a>
                </div>

                <figcaption class="small-10 medium-11 left">
                    <h3 class="divide-10"><a href="<?php echo $archive; ?>" title="<?php echo $term->name; ?>" class="primary"><?php echo $term->name; ?></a></h3>
                    <p class="no-margin"><?php echo $term->description; ?></p>
                    <?php
                        if(get_field('colunista_email',$term)) echo "<p class='font-small no-margin'>(". get_field('colunista_email',$term) .")</p>";
                    ?>
                </figcaption>
                <?php
                    endif;
